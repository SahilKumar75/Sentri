...
export default function SentriSheet({ visible, userName, onClose }) {
        ...
        <SafeAreaView style={styles.sheet}>
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              {starterPrompts.map((prompt) => (<Pressable key={prompt} style={styles.promptCard} onPress={() => {
                setDraft(prompt);
            ...
            <SurfaceCard>
              ...
              <TextInput value={draft} onChangeText={setDraft} placeholder="Ask a student task question" placeholderTextColor={theme.colors.textMuted} style={styles.input}/>
