        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <SurfaceCard>
              ...
              <DetailRow label="Phone verification" value={profile.phone ? (profile.verifiedPhone ? 'Verified' : 'Pending') : 'Not added'}/>
              <DetailRow label="Last login" value={profile.lastLoginAt ? formatDateTime(profile.lastLoginAt) : 'This device session is current'}/>
              <DetailRow label="Account created" value={profile.createdAt ? formatDateTime(profile.createdAt) : 'Unknown'}/>
            </SurfaceCard>

            {viewMode === 'settings' ? (<SurfaceCard>
